...
//   // Correct backend base for images only
//   const BASE_URL =
...
//     const fetchRestaurants = async () => {
//       try {
//         const res = await api.get("/restaurants"); // Correct endpoint
//         const data = res.data || [];
...
//     // If full URL (cloudinary)
//     if (img.startsWith("http")) return img;

//     // If stored in backend uploads
