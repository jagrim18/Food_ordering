...
//   // Timer logic for cancel countdown
//   useEffect(() => {
...
//             <motion.div className="rate-modal" initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.8 }}>
//               <h3>Rate Your Order</h3>
//               <div className="stars">
//                 {[1, 2, 3, 4, 5].map((s) => (
//                   <span key={s} onClick={() => setRating(s)} className={s <= rating ? "filled" : ""}>
//                     ★
//                   </span>
//                 ))}
//               </div>
//               <textarea value={review} onChange={(e) => setReview(e.target.value)} placeholder="Write your feedback..." />
//               <div className="modal-actions">
//                 <button onClick={submitRating} className="btn confirm">
//                   Submit
//                 </button>
//                 <button onClick={() => setShowRateModal(false)} className="btn cancel">
//                   Cancel
//                 </button>
//               </div>
//             </motion.div>
...
//       <AnimatePresence>
//         {showInvoiceModal && invoiceData && (
//           <motion.div className="invoice-modal-backdrop" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
//             <motion.div className="invoice-modal" initial={{ scale: 0.9 }} animate={{ scale: 1 }} exit={{ scale: 0.9 }}>
//               <h3>🧾 Invoice</h3>
//               <div className="invoice-details">
//                 <p><b>User:</b> {user?.name || "N/A"}</p>
//               </div>
...
//                 <p>Order ID: {invoiceData.orderId}</p>
//               </div>
//               <p className="invoice-date">Date: {new Date(invoiceData.date).toLocaleString()}</p>
//               <hr />
//               <div className="invoice-items">
//                 <table>
//                   <thead>
...
// import { AuthContext } from "../context/AuthContext";
// import { CartContext } from "../context/CartContext";
// import { CartDrawerContext } from "../context/CartDrawerContext"; // ✅ drawer context
// import { useNavigate } from "react-router-dom";
// import { io } from "socket.io-client";
// import "../styles/Orders.css";
...
//   const { user } = useContext(AuthContext);
//   const { addToCart, clearCart } = useContext(CartContext);
//   const { openCart } = useContext(CartDrawerContext); // ✅ global cart drawer control
//   const navigate = useNavigate();
...
//     // ✅ Open drawer or fallback to /cart
...
function Orders() {
  ...
  // ✅ Helper to get correct order display number
