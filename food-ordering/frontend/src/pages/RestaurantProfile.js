...
function RestaurantProfile() {
  ...
  /* ============================================================
     FIX: Wrap fetchProfile in useCallback so ESLint is happy
  ============================================================ */
  ...
  /* ============================================================
     FIX: useEffect now clean, ESLint error removed
  ============================================================ */
  useEffect(() => {
    fetchProfile();
  }, [fetchProfile]);
        ...
        <>
          ...
          <div className="rp-card gallery-card full-width-card">
            ...
            <div className="upload-area">
              ...
              {newImages.length > 0 && (
                <div className="selected-preview">
                  <div className="muted">Selected ({newImages.length}):</div>
                  <div className="selected-list">
                    {newImages.map((f, i) => (
                      <div key={i} className="selected-item">
                        <div className="selected-name">{f.name}</div>
