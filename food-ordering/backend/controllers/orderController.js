...
//   let counter = await OrderCounter.findOne({ name: "orderCounter" });

//   if (!counter) {
//     counter = await OrderCounter.create({ name: "orderCounter", seq: 0 });
//   }

//   counter.seq += 1;
//   await counter.save();

//   // Format: ORD00001, ORD00002, etc.
//   return `ORD${counter.seq.toString().padStart(5, "0")}`;
// };
