...
/* ============ NEW: Export Excel ==============
   Example:
     GET /api/restaurants/export-excel?start=2025-11-01&end=2025-11-07
   Protected: restaurantOnly
============================================== */
router.get("/export-excel", protect, restaurantOnly, restaurantController.exportRestaurantReport);
